...
<html>
	...
	<body link="#FFFFFF">
		<div style="width:750px; height:450px; overflow:hidden; margin: 0 auto; position:relative; margin-top:0px;">
			...
			<div id="section">
        <?php
	        include '../../controllers/ProcesarModPagina.php';
        ?>
				<a href="mp.php" class="menuButton mainMenuButton" style="margin-right:300px"><?php echo $Idioma['boton_volver'] ?></a>
			</div>
		</div>
	</body>
</html>
